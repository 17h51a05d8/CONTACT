...
<input type="text" id="speech" name="input" maxlength="150" size="150">
    ...
    <input type="submit"  value="search"/>
     <a href='index.php' class="btn btn-success btn-lg float-right" style='margin-right:16px'>BACK</a>
     </form>
        ...
        <p>
            ...
            <div class="form-group"> 
               ...
               <a href="import.php"  class="btn btn-success btn-lg" 
                      style='margin-right:16px' > 
                    <i class="fa fa-plus-square-o"></i>
                   IMPORT  </a> <button onclick="changelocation();this.disabled='false';">Disable Me</button>
